...
import ca.utoronto.cs.prefuseextensions.control.RestrictedDragControl.Axis;
 ...
 */
public class RestrictedForceDirectedLayout extends Layout {
     ...
     */
    public RestrictedForceDirectedLayout(String graph)
    {
     ...
     */
    public RestrictedForceDirectedLayout(String group, boolean enforceBounds)
    {
     ...
     * layout is computed.
     */
    public RestrictedForceDirectedLayout(String group,
     ...
     * layout is computed.
     */
    public RestrictedForceDirectedLayout(String group, ForceSimulator fsim,
            boolean enforceBounds, boolean runonce)
    {
        super(group);
        m_nodeGroup = PrefuseLib.getGroupName(group, Graph.NODES);
