...
import ca.utoronto.cs.prefuseextensions.lib.MyImageFactory;
 ...
 */
public class CollageGradientLabelRenderer extends LabelRenderer {

    protected MyImageFactory m_images = null;
     ...
     */
    public CollageGradientLabelRenderer() {
    }
     ...
     */
    public CollageGradientLabelRenderer(String textField) {
     ...
     * drawn.
     */
    public CollageGradientLabelRenderer(String textField, String imageField) {
    ...
    public void setImageField(String imageField) {
        if ( imageField != null ) m_images = new MyImageFactory();
    ...
    public void setMaxImageDimensions(int width, int height) {
        if ( m_images == null ) m_images = new MyImageFactory();
    ...
    protected Image getImage(VisualItem item) {
        ...
        return ( imageLoc == null ? null : m_images.getTwoByTwoImage(imageLoc) );
    }
    ...
    public void render(Graphics2D g, VisualItem item) {
        ...
        if ( type==RENDER_TYPE_FILL || type==RENDER_TYPE_DRAW_AND_FILL )
            MyGraphicsLib.gradientPaint(g, item, shape, getStroke(item), RENDER_TYPE_FILL);
        ...
        if (type==RENDER_TYPE_DRAW || type==RENDER_TYPE_DRAW_AND_FILL) {
            MyGraphicsLib.gradientPaint(g,item,shape,getStroke(item),RENDER_TYPE_DRAW);
        }
    }
     ...
     */
    public void setImageFactory(MyImageFactory ifact) {
        m_images = ifact;
    }
