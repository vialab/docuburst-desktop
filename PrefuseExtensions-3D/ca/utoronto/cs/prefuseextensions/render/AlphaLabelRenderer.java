 ...
 */
public class AlphaLabelRenderer extends AbstractShapeRenderer {
     ...
     */
    public AlphaLabelRenderer(String textField) {
     ...
     * drawn.
     */
    public AlphaLabelRenderer(String textField, String imageField) {
    ...
    public void render(Graphics2D g, VisualItem item) {
        ...
        if ( img != null ) {            
            ...
            if ( useInt && size == 1.0 ) {
                ...
                g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, ((float)ColorLib.alpha(item.getFillColor()))/255f));
...
} // end of class AlphaLabelRenderer
