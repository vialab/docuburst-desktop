...
public class ExportDisplayAction extends AbstractAction {
    ...
    private void init() {
        ...
        // Adding the PDF option
        chooser.setFileFilter(new SimpleFileFilter("pdf", "PDF (*.pdf)"));
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if ( !success ) {
            JOptionPane.showMessageDialog((JComponent)display,
                    "Error Saving Image!",
                    "Image Save Error",
