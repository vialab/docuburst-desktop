 ...
 */
public class DisplayComponent extends JComponent implements Display {

    public static final Logger s_logger 
        = Logger.getLogger(DisplayComponent.class.getName());
     ...
     */
    public DisplayComponent(Visualization visualization) {
     ...
     */
    public DisplayComponent(Visualization visualization, String predicate) {
        this(visualization,
     ...
     */
    public DisplayComponent(Visualization visualization, Predicate predicate) {
    ...
    public boolean saveImage(OutputStream output, String format, double scale)
    {
        try {
            ...
            if (format.equals("pdf")){
            	...
            	Document document = new Document(new com.itextpdf.text.Rectangle(0, d.height, d.width, 0));
...
//            	PdfTemplate template = cb.createTemplate(PageSize.A4.getWidth(), PageSize.A4.getHeight());
            	PdfGraphics2D g2d = new PdfGraphics2D(cb, d.width, d.height, true);
            	//Graphics2D g2d = template.createGraphicsShapes(PageSize.A4.getWidth(), PageSize.A4.getHeight());
